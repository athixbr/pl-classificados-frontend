      ...
      <section className="relative py-12 md:py-16 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <div 
            ...
            style={{
              backgroundImage: 'url("https://images.unsplash.com/photo-1552820728-8ac41f1ce891?w=1200&h=400&fit=crop")',
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <p className="text-lg text-white/90 font-semibold drop-shadow-lg mb-8">
            Encontre os melhores carros, motos e outros veículos
          </p>
      ...
      <section className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="flex gap-2 mb-8 overflow-x-auto pb-2">
            ...
            <Button variant="outline" className="whitespace-nowrap">Carros</Button>
            <Button variant="outline" className="whitespace-nowrap">Motos</Button>
            <Button variant="outline" className="whitespace-nowrap">Caminhões</Button>
            <Button variant="outline" className="whitespace-nowrap">Novos</Button>
            <Button variant="outline" className="whitespace-nowrap">Usados</Button>
          </div>
