      ...
      <section className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="flex gap-2 mb-8 overflow-x-auto pb-2">
            ...
            <Button variant="outline" className="whitespace-nowrap">Full Time</Button>
            <Button variant="outline" className="whitespace-nowrap">Part Time</Button>
            <Button variant="outline" className="whitespace-nowrap">Remoto</Button>
            <Button variant="outline" className="whitespace-nowrap">Estágio</Button>
          </div>
