      ...
      <section className="relative py-12 md:py-16 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <p className="text-lg text-white/90 font-semibold drop-shadow-lg mb-8">
            Encontre profissionais para diversos serviços
          </p>
      ...
      <section className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="flex gap-2 mb-8 overflow-x-auto pb-2">
            ...
            <Button variant="outline" className="whitespace-nowrap">Reparos</Button>
            <Button variant="outline" className="whitespace-nowrap">Limpeza</Button>
            <Button variant="outline" className="whitespace-nowrap">Reforma</Button>
            <Button variant="outline" className="whitespace-nowrap">Delivery</Button>
          </div>
